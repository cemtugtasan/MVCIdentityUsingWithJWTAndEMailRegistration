...
namespace TheoryPractice.Migrations
{
    ...
    [Migration("20230509072924_V.1.0.1")]
    partial class V101
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6df6c362-3d13-4082-95f4-7e6b476aa8f0",
                            ConcurrencyStamp = "4e997804-beaf-4d6c-8e50-9e49d0ddad68",
                            Name = "admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "938c1d83-8413-43c2-811d-af070fa8c5d4",
                            ConcurrencyStamp = "5118172b-2843-421d-ad4b-72abeb40064e",
                            Name = "Editör",
                            NormalizedName = "EDITOR"
                        },
                        new
                        {
                            Id = "846a4c3c-94bd-4b76-87f0-0fcfe1301ff3",
                            ConcurrencyStamp = "8ac38107-a5b9-4ee0-99ef-b52dbca0ab6e",
                            Name = "Oyuncu",
            ...
            modelBuilder.Entity("TheoryPractice.Context.Category", b =>
                {
            ...
            modelBuilder.Entity("TheoryPractice.Context.Customer", b =>
                {
            ...
            modelBuilder.Entity("TheoryPractice.Context.Employee", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheoryPractice.Context.Order", b =>
                {
            ...
            modelBuilder.Entity("TheoryPractice.Context.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("TheoryPractice.Context.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheoryPractice.Context.Region", b =>
                {
            ...
            modelBuilder.Entity("TheoryPractice.Context.Shipper", b =>
                {
            ...
            modelBuilder.Entity("TheoryPractice.Context.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TheoryPractice.Context.Territory", b =>
                {
                    b.Property<string>("TerritoryId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("TheoryPractice.Context.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("FK_EmployeeTerritories_Employees");

                    b.HasOne("TheoryPractice.Context.Territory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TheoryPractice.Context.Employee", b =>
                {
                    b.HasOne("TheoryPractice.Context.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("TheoryPractice.Context.Order", b =>
                {
                    b.HasOne("TheoryPractice.Context.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("TheoryPractice.Context.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("TheoryPractice.Context.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("TheoryPractice.Context.OrderDetail", b =>
                {
                    b.HasOne("TheoryPractice.Context.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .IsRequired()
                        .HasConstraintName("FK_Order_Details_Orders");

                    b.HasOne("TheoryPractice.Context.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("TheoryPractice.Context.Product", b =>
                {
                    b.HasOne("TheoryPractice.Context.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("TheoryPractice.Context.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("TheoryPractice.Context.Territory", b =>
                {
                    b.HasOne("TheoryPractice.Context.Region", "Region")
